...
public class Startup {
	...
	private static void loadAppointmentMenu() {
		System.out.println(
				"Enter Method : 1=addNewAppointment ,2=getPatientById ,3=updateAppointment ,4=updatePatientName ,5=updateFeesCollected ,6=getAllAppointmentDetails ,7=deleteAppointment ");
		java.util.Scanner sc = new java.util.Scanner(System.in);
		try {
			int call = sc.nextInt();
			switch (call) {
